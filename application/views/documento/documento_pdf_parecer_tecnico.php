...
if($objeto->objetivo != null){
	...
	$html .= '
		...
		<div class="redacao">	
			...
			<br>
			<p>
			<span class="parte">1. OBJETIVO</span>
			'.$objeto->objetivo.'
			</p>

			<p>
			<span class="parte">2. DOCUMENTAÇÃO</span>
			'.$objeto->documentacao.'
			</p>
					
			<p>
			<span class="parte">3. ANÁLISE</span>
			'.$objeto->analise.'
			</p>
					
			<p>
			<span class="parte">4. CONCLUSÃO E PARECER</span>
			'.$objeto->conclusao.'
			</p>
